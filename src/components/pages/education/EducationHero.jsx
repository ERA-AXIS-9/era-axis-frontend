      ...
      <div className="max-w-none px-0">
        ...
        >
          ...
          <div className="relative px-4 sm:px-6 md:px-10 lg:px-14 py-16 sm:py-20 md:py-24 lg:py-32 min-h-[500px] md:min-h-[580px] lg:min-h-[680px] flex items-center">
            ...
            {/* Left Content */}
            <div className="max-w-3xl pt-8 sm:pt-12 md:pt-16 lg:pt-20">
              {/* Main Heading */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 sm:mb-8 md:mb-10 leading-tight">
                STEM for All. Innovation Without Barriers.
              </h1>

              {/* Subtitle */}
              <p className="text-base sm:text-lg md:text-xl text-white/90 mb-10 sm:mb-12 md:mb-14 leading-relaxed">
