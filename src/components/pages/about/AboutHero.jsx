...
const AboutHero = () => {
  ...
  return (
    <section className="pt-4 pb-8 lg:pt-6 lg:pb-12 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Card Container with Border Radius */}
        <div className="p-6 sm:bg-white sm:rounded-xl sm:border sm:border-gray-200 sm:shadow-sm sm:p-8 lg:p-12">
