...
const PartnerTestimonials = () => {
  const testimonials = [
    {
      quote: "ERA AXIS delivered a solution that perfectly fit our needs and exceeded our expectations.",
      author: "John Doe",
      role: "CEO, Tech Company",
      type: "partner"
    },
    {
      quote: "Their approach is practical and their work has made a real difference in our community outreach.",
      author: "Jane Smith",
      role: "Director, NGO",
      type: "partner"
    },
    {
      quote: "Working with ERA AXIS has transformed how we deliver services to our community.",
  ...
  return (
    <section className="py-9 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black tracking-tight mb-6">What Partners Say</h2>
