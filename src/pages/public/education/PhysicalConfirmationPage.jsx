  ...
  const nextSteps = [
    {
      ...
      description: 'Confirmation email sent with enrollment details.',
      color: '#39366F'
    },
    {
      icon: Phone,
      title: 'Expect our call',
      description: 'We\'ll contact you within 48 hours to confirm your enrollment and schedule.',
      color: '#5B9BD5'
    },
    {
      icon: MapPin,
      title: 'Visit our facility',
      description: 'You\'ll receive location details and class schedule via email.',
      color: '#2a2850'
    }
  ];
      ...
      <section className="pt-16 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black mb-4">
            Physical Classroom Enrollment Received!
          </h1>

          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Thank you for choosing ERA AXIS. We'll contact you soon to complete your enrollment.
          </p>
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-start">
                  <span className="text-sm font-semibold text-gray-700">Learning Mode</span>
              ...
              <div className="mt-6 p-4 bg-blue-50 border border-blue-100 rounded-lg">
                <p className="text-sm text-blue-900">
                  <span className="font-semibold">📧 Confirmation sent!</span> Check your email for enrollment details.
                </p>
              </div>
              ...
              <div className="mt-6 p-4 bg-green-50 border border-green-100 rounded-lg">
                <p className="text-sm text-green-900">
                  <span className="font-semibold">✓ No Payment Required</span><br />
                  Your registration is free. Payment details will be discussed during confirmation call.
                </p>
              </div>
            </div>
