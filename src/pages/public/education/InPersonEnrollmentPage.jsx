...
import { Users, MapPin, Calendar, Clock, ChevronRight, AlertCircle } from 'lucide-react';
...
const InPersonEnrollmentPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Navigate to in-person confirmation page
    navigate(`/services/education/in-person-confirmation?program=${programId}`, { 
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        >
                          ...
                          <option value="weekday-afternoon">Weekday Afternoons (1pm-4pm)</option>
                          ...
                          <option value="weekend-afternoon">Weekend Afternoons (1pm-4pm)</option>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-black mb-1">In-Person Learning</p>
                        <p className="text-sm text-gray-600">Face-to-face instruction at our facility</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">ERA AXIS Innovation Hub</p>
                      </div>
                    </div>
                  </div>
...
export default InPersonEnrollmentPage;
