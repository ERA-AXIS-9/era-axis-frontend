...
import { Monitor, MapPin, Calendar, Clock, ChevronRight } from 'lucide-react';
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Program: <span className="font-semibold text-[#39366F]">{program.name}</span> • {program.duration}
              </p>
            </div>
          </div>
        </div>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          required
                          className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#39366F] focus:border-transparent outline-none transition-all bg-white text-sm"
                        >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          required
                          className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#39366F] focus:border-transparent outline-none transition-all resize-none text-sm bg-white"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <div className="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-100">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h3 className="text-sm font-bold text-black">Learning Commitment</h3>
                    </div>
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        >
                          ...
                          <option value="more-20">More than 20 hours</option>
                        </select>
                      </div>
                      <div className="bg-white p-4 rounded-lg border border-gray-200">
                        ...
                        <div className="space-y-2">
                          <label className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded transition-colors">
                            <input
                              type="checkbox"
                              name="internetAccess"
                              ...
                              onChange={handleInputChange}
                              required
                              className="w-4 h-4 text-[#39366F] border-gray-300 rounded focus:ring-[#39366F]"
                            />
                            <span className="text-sm text-gray-700">I have reliable internet access</span>
                          </label>
                          <label className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded transition-colors">
                            <input
                              type="checkbox"
                              ...
                              className="w-4 h-4 text-[#39366F] border-gray-300 rounded focus:ring-[#39366F]"
                            />
                            <span className="text-sm text-gray-700">I have access to a computer/laptop/tablet</span>
                          </label>
                        </div>
                      </div>
                    </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Learn at your own pace from anywhere</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Study when it works for you</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-sm text-blue-800">
                      After completing this form, you'll proceed to payment to secure your spot in the program.
                    </p>
                  </div>

                  <div className="bg-green-50 border border-green-100 rounded-lg p-4">
                    <p className="text-sm text-green-900 font-semibold mb-2">💡 Online Benefits:</p>
                    <div className="space-y-1">
                      <p className="text-sm text-green-800">✓ 24/7 course access</p>
                      <p className="text-sm text-green-800">✓ Virtual mentorship</p>
                      <p className="text-sm text-green-800">✓ Digital certificate</p>
                      <p className="text-sm text-green-800">✓ Global community</p>
                    </div>
                  </div>
                </div>
              </div>
